...
def create_wpa_supplicant(ssid, wifi_key):
    ...
    os.system('mv wpa_supplicant.conf.tmp /etc/wpa_supplicant/wpa_supplicant-wlan1.conf')   #appended here ashah

def set_ap_client_mode():
#    os.system('rm -f /etc/raspiwifi/host_mode')   #removed ashah
#    os.system('rm /etc/cron.raspiwifi/aphost_bootstrapper') #removed ashah
#    os.system('cp /usr/lib/raspiwifi/reset_device/static_files/apclient_bootstrapper /etc/cron.raspiwifi/') #removed ashah
#    os.system('chmod +x /etc/cron.raspiwifi/apclient_bootstrapper') #removed ashah
#    os.system('mv /etc/dnsmasq.conf.original /etc/dnsmasq.conf') #removed ashah
#    os.system('mv /etc/dhcpcd.conf.original /etc/dhcpcd.conf') #removed ashah
    os.system('reboot')
